...
return (
<div className='p-3 d-flex container-fluid '>
...
<div className="container-fluid ">
 ...
 <div><Link className="navbar-brand text-white d-flex align-items-center fw-bolder" to="/"><i className="fa-solid fa-tags mx-1"></i>shopit</Link></div> 
  ...
  <div className='d-flex  align-items-center '><form className="d-flex" role="search" onSubmit={handleOnSubmit}>
    ...
    <Link className='nav-link mx-3' to={"/usercart"}><span><sup className='bg-dark fw-bold  px-1 rounded-circle text-white'>{cartCount}</sup><i className="fa-solid fa-cart-shopping" style={{color:"#ffffff"}}></i></span></Link> </div>
  
</div>

</nav>
<button className="btn btn-sm btn-primary m-1 " type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
          account
        </button>
